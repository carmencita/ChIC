...
print(inputname)
file_metaprofili<-paste(outputdir,"/two.point.scaling_",datafilename, ".RData", sep="")
...
pdf(file=paste(plotsdir,"/NOnormalizaztion_",TFname,"_",datafilename ,".pdf", sep=""), width=1024)
...
pdf(file=paste(plotsdir,"/Normalized_",TFname,"_", datafilename, ".pdf", sep=""), width=1024)
    par(mar = c(3.5,3.5,2.0,0.5), mgp = c(2,0.65,0), cex = 1);
